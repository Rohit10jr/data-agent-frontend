        ...
        <>
          <SettingsCard title="Deploy your first project">
            <div className="space-y-3 text-sm text-muted-foreground">
              <p>
                Use <code>Queryn deploy</code> to send a local project context
                to this Queryn instance.
              </p>
              <p>
                Run it from the directory that contains{" "}
                <code>nao_config.yaml</code>, or add{" "}
                <code>--path /path/to/project</code> if you want to deploy from
                somewhere else.
              </p>
            </div>
          </SettingsCard>
